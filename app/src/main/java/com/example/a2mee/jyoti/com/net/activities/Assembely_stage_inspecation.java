...
public class Assembely_stage_inspecation extends Activity {
    ...
    String rejectqty1o;
    String Acceptqtyo;
    String BARCODEDATAo, lotQtyo, userido, userid, fffvo, Acceptqty1dd, Acceptqty1o, lotQtyqqo, reasonnameqo, ResionIdqo;
    String Qtkk;
    String REASONINSPECTION = Config.BASE_URL + "assembly/rejectResonListForOlInspection";
    // String QRCODECODEQTY = Config.BASE_URL +"assembly/assemblyStageInspection";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assembely_stage_inspecation);
        barcodedataafost = findViewById(R.id.barcodedataafqq);
        ...
        scannbuttonost = findViewById(R.id.butscanfinelqq);
        saveButtonost = findViewById(R.id.Submithhhfqq);
        saveanotherost = findViewById(R.id.Submitkkfqq);
        LotQtyost = findViewById(R.id.lotqttyjqq);
        //Accept = findViewById(R.id.accepiidf);
        holdresonost = findViewById(R.id.holdresfqq);
        holdQtyost = findViewById(R.id.Holdfqq);
        rejectqtyost = findViewById(R.id.Rejectfqq);
        acceptQtyost = findViewById(R.id.acceptQtyqq);
        opraterost = findViewById(R.id.opraterfqq);
        RejectionResionost = findViewById(R.id.Rejectionfqq);

        scannbuttonost.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                IntentIntegrator scan = new IntentIntegrator(Assembely_stage_inspecation.this);
...
//
        holdQtyost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (BARCODEDATAo == null) {
                    ...
                    holdQtyost.setText("");
                    Toast.makeText(Assembely_stage_inspecation.this, "Please scan the QR code", Toast.LENGTH_SHORT).show();
                } else {
            ...
            public void onClick(View view) {
                ...
                if (BARCODEDATAo == null) {
                    ...
                    if (lotQtyo.equalsIgnoreCase(null)) {
                        Toast.makeText(Assembely_stage_inspecation.this, "No Data Found !! Pleasse Scan Again", Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    if (Lotqty1 >= totalqtyo) {
                        ...
                        if (us1 == 0) {
                            Toast.makeText(Assembely_stage_inspecation.this, "Quantity is 0 ", Toast.LENGTH_SHORT).show();
                        } else {
                            SAvedatato();
                        }
                    } else {
                        Toast.makeText(Assembely_stage_inspecation.this, "Quantity is grater than Lot Quantity", Toast.LENGTH_SHORT).show();
                        Resetall();
                    }
                }
    ...
    private void SAveanotherto() {
        ...
        if (BARCODEDATAo == null) {
            Toast.makeText(Assembely_stage_inspecation.this, "SCAN OR CODE", Toast.LENGTH_SHORT).show();
        ...
        JsonObjectRequest stageRequestInspect_Materialdate1 = new JsonObjectRequest(Request.Method.POST, SAVEANOTHER, userdatadata11, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Assembely_stage_inspecation.this, "Something Went Wrong !!!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SAvedatato() {
        ...
        JsonObjectRequest stageRequestInspect_Materialdateoo = new JsonObjectRequest(Request.Method.POST, SAVEDATA, userdatadata1, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Assembely_stage_inspecation.this, "Done", Toast.LENGTH_SHORT).show();
            }
        });
        RequestQueue Inspect = Volley.newRequestQueue(getApplicationContext());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultContents == null) {
            ...
            Toast.makeText(Assembely_stage_inspecation.this, resultContents, Toast.LENGTH_LONG).show();
    ...
    private void Reasonlist_of_onlineassembley() {
        ...
        JsonArrayRequest stageRequestdatezz = new JsonArrayRequest(Request.Method.GET, REASONINSPECTION, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                ArrayAdapter<String> spinnerArrayrr = new ArrayAdapter<String>(Assembely_stage_inspecation.this, android.R.layout.simple_spinner_dropdown_item, reasonname);
